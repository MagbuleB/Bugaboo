Feature: Filling the form in Product Registration
  ...
  #Invalid inputs|               |               |                   |                 |            |           |                   |                   |                 |                  |                  |             |         |
  #| &!$%&         | 55546789@#$   |                   |                 | 145654676  | 565463464 | notavalidemail    | notavalidemail    | notaphonenumber | !@#$%^&*         | !@##$%^          | 342534@#$$% | @#$#556 |
    #  |               |               |                   |                      |            |           |                   |                   |              |                  |                  |        |          |

#No product found with this serial number. Please check your input and try again.